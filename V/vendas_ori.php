...
?>
    ...
    <div class="tab-content" id="myTabContent">
        ...
        <!--________________________select para procurar_________-->
        <?php
        ...
        <tr class="tbody">
            ...
            <td>
                <a href="carrinho.php?adicionar=<?php echo $resultActual["id_produto"]; ?>" class="green_center"><i class="fa-solid fa-plus fa-beat"></i></a>
            </td>
        </tr>
        <?php endfor?>
                 ...
                 <?php else: 
                    echo " <script> window.alert('Não existe na tabela')</script>"; 
                endif?>
        ...
        <tr class="cabecalho_tabela">           
            ...
            #________selecionar os dados da tabela 
                $query = $pdo->prepare("SELECT id_venda, tb_usuario.nome, tb_produto.descricao, quantidade, data_venda FROM tb_venda INNER JOIN tb_usuario INNER JOIN tb_produto on tb_produto.fk_usuario = id_usuario  and tb_venda.fk_produto = id_produto");
                $query->execute();
            ...
            <tr class="tbody">
                ...
                <td>
                    <a href="#" class="green"><i class="fa-solid fa-pen "></i></a>
